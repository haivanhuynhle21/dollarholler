...
<div class="mb-16 flex items-center justify-between">
  ...
  <div>
    <button
      class="relative translate-y-0 whitespace-nowrap rounded-lg bg-lavenderIndigo py-3 px-10 font-sansSerif text-xl font-black text-white shadow-colored transition-all hover:-translate-y-2 hover:shadow-coloredHover"
      >+ Invoice</button
    >
  </div>
</div>
...
<div class="invoice-table items-center rounded-lg bg-white py-6 shadow-tableRow">
  ...
  <div class="text-lg"><a class="text-pastelPurple hover:text-daisyBush" href="#"><View /></a></div>
